# Solar Forecast ML V12.8 "Sarpeidon" - 1st HA Full Hybrid-AI Solar Forecast

[![Version](https://img.shields.io/badge/version-12.8.0-blue.svg)](https://github.com/Zara-Toorox/ha-solar-forecast-ml)
...
Imagine your smart home not just reacting, but *predicting* - using Hybrid-AI that adapts daily to your unique solar installation. That's exactly what Solar Forecast ML does. With **Version 12.8.0 "Sarpeidon"** we introduce enhanced **Multi-Weather Blending**, **Per-Panel-Group Learning**, **Learning Filters**, and the new **SFML Stats Lite** dashboard for all platforms.
...
## New in Version 12.8.0 "Sarpeidon"
