...
def create_default_learned_weights() -> LearnedWeights:
    ...
    """
    default_feature_names = [ # Match FeatureEngineer base features initially
        ...
        # Polynomial and interaction features are derived, not stored directly as base weights usually
    ]
