"""Electricity Price Service for Grid Price Monitor Integration V1.0.0 @zara

Fetches day-ahead electricity prices from the aWATTar API.
Supports Germany (DE) and Austria (AT) markets.
