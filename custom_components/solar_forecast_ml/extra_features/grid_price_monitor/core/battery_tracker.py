"""Battery Charging Statistics Tracker for Grid Price Monitor Integration V1.0.0 @zara

Tracks battery charging from grid using Left Riemann Sum for kWh calculation.
