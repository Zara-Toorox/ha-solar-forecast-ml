"""Data Update Coordinator for Grid Price Monitor Integration V1.0.0 @zara

Manages periodic updates of electricity price data and calculations.

Price Calculation:
- Spot price from aWATTar is NET (without VAT)
- Total price = (Spot price × VAT factor) + Grid fee + Taxes/Fees + Provider markup
- Grid fee, taxes, and provider markup are entered as GROSS values by user
