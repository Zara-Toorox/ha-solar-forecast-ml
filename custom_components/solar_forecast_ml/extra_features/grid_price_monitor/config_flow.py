"""Configuration Flow for Grid Price Monitor Integration V1.0.0 @zara

Provides setup, reconfigure and options flow for configuring:
- Country selection (DE/AT)
- VAT rate selection (19%, 20%, 7%, 0%)
- Grid fees, taxes, and provider markup
- Maximum price threshold for cheap energy detection
