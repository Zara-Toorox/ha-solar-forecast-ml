...
class LearnedWeights:
    ...
    )  # Can be calculated post-training
...
def create_default_learned_weights() -> LearnedWeights:
    """Creates a LearnedWeights object with default values - V2 with 44 features"""
    # V2 Feature Engineering: 44 features total
    ...
    _LOGGER.info(
        f"Creating default LearnedWeights with {len(default_feature_names)} V2 features (triggers immediate training)"
    )
