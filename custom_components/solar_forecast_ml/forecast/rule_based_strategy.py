...
class RuleBasedForecastStrategy(ForecastStrategy):
    ...
    Berechnet eine iterative stÃƒÆ’Ã‚Â¼ndliche Prognose fÃƒÆ’Ã‚Â¼r alle 24 Stunden.
    """
    ...
    async def calculate_forecast(
        ...
        **kwargs
        ...
        correction factor, iteriert ÃƒÆ’Ã‚Â¼ber die stÃƒÆ’Ã‚Â¼ndliche Wettervorhersage.

        Args:
            hourly_weather_forecast: Liste der verarbeiteten stÃƒÆ’Ã‚Â¼ndlichen Wettervorhersagen.
        ...
        try:
            ...
            try:
                ...
                if current_yield is not None and current_yield > 0:
                    ...
                    if current_yield_float > today_forecast_kwh:
                        ...
                        _LOGGER.info(
                            ...
                            f"UrsprÃƒÆ’Ã‚Â¼ngliche Prognose {today_forecast_kwh:.2f} kWh. "
                ...
                _LOGGER.debug(f"Mindest-Prognose Check (Regel) konnte nicht durchgefÃƒÆ’Ã‚Â¼hrt werden: {e}")
    ...
    def _get_hour_factor(self, hour: int) -> float:
        ...
        fÃƒÆ’Ã‚Â¼r eine gegebene Stunde. Nachtstunden (22-5) erhalten Faktor 0.
        """
        try:
